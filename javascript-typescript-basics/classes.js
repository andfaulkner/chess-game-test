...
const somePiece = new CheckersPiece('black', 3, 3);
console.log(`somePiece:`, somePiece);

somePiece.setNewPosition(5, 5);
console.log(`somePiece:`, somePiece);

console.log(`somePiece.coords():`, somePiece.coords());
